...
import { Sidebar } from '../../../components/vinyl-application-tapes/application-tape/Sidebar';
import ProductImage from '../../../components/vinyl-application-tapes/application-tape/ProductImage';
...
const ApplicationTape = ( data, imageData ) => {
    const arr = [];
    ...
    return (
        ...
        <div style={{display: "flex", flexDirection: "row", justifyContent: "center"}}>
            ...
            <h1 style={{width: "50%"}}>Application Tape</h1>
...
export default ApplicationTape;