...
import { Sidebar } from '../../../components/vinyl-application-tapes/cut-vinyl/translucent-vinyl/Sidebar';
import ProductImage from '../../../components/vinyl-application-tapes/cut-vinyl/translucent-vinyl/ProductImage';
...
const TranslucentVinyl = ( data, imageData ) => {
    const arr = [];
    ...
    return (
        ...
        <div style={{display: "flex", flexDirection: "row", justifyContent: "center"}}>
            ...
            <h1 style={{width: "50%"}}>Translucent Vinyl</h1>
...
export default TranslucentVinyl;