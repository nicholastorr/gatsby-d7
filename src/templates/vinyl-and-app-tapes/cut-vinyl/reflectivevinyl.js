...
import { Sidebar } from '../../../components/vinyl-application-tapes/cut-vinyl/reflective-vinyl/Sidebar';
import ProductImage from '../../../components/vinyl-application-tapes/cut-vinyl/reflective-vinyl/ProductImage';
...
const ReflectiveVinyl = ( data, imageData ) => {
    const arr = [];
    ...
    return (
        ...
        <div style={{display: "flex", flexDirection: "row", justifyContent: "center"}}>
            ...
            <h1 style={{width: "50%"}}>Reflective Vinyl</h1>
...
export default ReflectiveVinyl;