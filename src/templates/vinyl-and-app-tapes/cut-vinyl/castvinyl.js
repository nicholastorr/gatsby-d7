...
import ProductImage from '../../../components/vinyl-application-tapes/cut-vinyl/cast-vinyl/ProductImage';
import  styled  from 'styled-components';
import { Sidebar } from '../../../components/vinyl-application-tapes/cut-vinyl/cast-vinyl/Sidebar';
...
const CastVinyl = ( data, imageData ) => {
    ...
    return (
        ...
        <div style={{display: "flex", flexDirection: "row", justifyContent: "center"}}>
            {/* Filtering is handled by sidebar*/ }
            <Sidebar 
            products={products}
            ...
            {products.slice(0, count).map(product => {
                // conditional will display "display" products first if a filter is not selected
