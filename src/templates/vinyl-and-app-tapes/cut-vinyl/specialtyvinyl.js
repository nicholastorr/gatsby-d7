...
import { Sidebar } from '../../../components/vinyl-application-tapes/cut-vinyl/specialty-vinyl/Sidebar';
import ProductImage from '../../../components/vinyl-application-tapes/cut-vinyl/specialty-vinyl/ProductImage';
...
const SpecialtyVinyl = ( data, imageData ) => {
    const arr = [];
    ...
    return (
        ...
        <div style={{display: "flex", flexDirection: "row", justifyContent: "center"}}>
            ...
            <h1 style={{width: "50%"}}>Specialty Vinyl</h1>
