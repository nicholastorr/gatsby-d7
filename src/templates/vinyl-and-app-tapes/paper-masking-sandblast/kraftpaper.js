...
import { Sidebar } from '../../../components/vinyl-application-tapes/paper-masking-sandblast/kraft-paper/Sidebar';
import ProductImage from '../../../components/vinyl-application-tapes/paper-masking-sandblast/kraft-paper/ProductImage';
...
const Masking = ( data, imageData ) => {
    ...
    return (
        ...
        <div style={{display: "flex", flexDirection: "row", justifyContent: "center"}}>
            ...
            <h1 style={{width: "50%"}}>KRaft Paper</h1>
